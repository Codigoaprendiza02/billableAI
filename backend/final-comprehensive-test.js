  ...
  async testEmailTrackingStop(sessionId) {
    ...
    try {
      ...
      if (response.data.billingSummary) {
        ...
        console.log(`   - Time Spent: ${response.data.timeSpent}ms`);
        console.log(`   - Hours: ${response.data.billingSummary.hours}`);
        console.log(`   - Activity Type: ${response.data.billingSummary.metadata.activityType}`);
        console.log(`   - Word Count: ${response.data.billingSummary.metadata.wordCount}`);
      }
